...
local main = {
    ...
    command = {
        ...
        ["x"] = "ToggleAccumulatorRegister",  -- x<register>: toggle track in/out of register
        ["X"] = "RecallAccumulatorRegister",  -- X<register>: recall tracks from register
        ["gX"] = "ClearAccumulatorRegister",  -- gX<register>: clear register
        ["<M-j>"] = "NextEnvelope",
        ["<M-k>"] = "PrevEnvelope",
        ["<C-+>"] = "ZoomInVert",
        ["<C-->"] = "ZoomOutVert",
