...
return {
    ...
    ToggleAccumulatorRegister = { movements.toggleAccumulatorRegister, registerAction = true },
    RecallAccumulatorRegister = { movements.recallAccumulatorRegister, registerAction = true },
    ClearAccumulatorRegister = { movements.clearAccumulatorRegister, registerAction = true },
    ClearAllAccumulators = movements.clearAllAccumulators,
    RestoreAllAccumulators = movements.restoreAllAccumulators,
    ShowBigClock = 40378,
    ShowDocker = 40279,
