...
return {
    ...
    MoveTracksToFolder = 42786,
    MakeNewFolderFromTracksAndName = "_9820642174eb4a7eb6ad675f10a4c712",
    MakeFolderFromSelectedTracks = "_SWS_MAKEFOLDER",
    ...
    DuplicateTrack = 40062,
    DuplicateTrackEmpty = "_098d275fab6f46cabc751dae4732d645",
    ...
    HideTracks = { "SelectFolder", 41593 },
    HideMutedTracksAndChildren = "_d1d0d5d74eab4ed098f8e72cdd1ef7ba",
    ShowAllTracks = "_SWSTL_SHOWALL",
    ...
    MoveItemToMediaSourcePreferredPosition = 40299,
    ...
    SaveItemAndRenderProjectProxy = 42332,
    SyncParentProjectsOnPlayback = 41994,
    ...
    ResetSelection = {
        ...
        "UnselectAllEvents" },
    Reset = { "SetModeNormal", "SetRecordModeNormal", "ResetSelection" },
    ...
    SetGridWhole         = movements.setGridWhole,
    SetGridHalf          = movements.setGridHalf,
    SetGridQuarter       = movements.setGridQuarter,
    SetGridEighth        = movements.setGridEighth,
    SetGridSixteenth     = movements.setGridSixteenth,
    SetGridThirtySecond  = movements.setGridThirtySecond,
    GridFiner   = movements.gridFiner,
    GridCoarser = movements.gridCoarser,
    ...
    LoadWindowSet5 = 40458,
    SaveWindowSet1 = 40679,
    SaveWindowSet2 = 40680,
    SaveWindowSet3 = 40681,
    SaveWindowSet4 = 40682,
    SaveWindowSet5 = 40683,
    ...
    ToggleTrimContentBehindItems = 41117,
    ...
    ToggleExclusiveRecordArm = "_RS985b479d9c749b0953ab1ab22f20b5ed48b0f1b6", -- Script: Yannick_Set exclusive record arm for track or toggle folder collapse.lua
